...
// finds it (uprv_getDefaultLocaleID), which is what Node writes dates and
// zone names in when a program names no locale. On Windows it is the
// user's locale; elsewhere it is LC_ALL, LC_MESSAGES or LANG, its codeset
// dropped, "C" and "POSIX" being en_US_POSIX. What cannot be read is
// "en-US".
