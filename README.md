...
| `DateTimeFormat` | Complete in eleven calendars -- Gregorian, Buddhist, Persian, Coptic, Ethiopic (both eras), Indian, civil and tabular Islamic, ROC, Hebrew: styles, fields, hour cycles, day periods, fractional seconds, every `timeZoneName` style, offset time zones, ranges. Japanese, ISO 8601, the astronomical Islamic ones, Chinese and Dangi are to come |
